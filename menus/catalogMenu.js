...
const catalog = [
	...
	{ name: "Новогодние товары", description: "Создайте праздничную атмосферу с нашими новогодними товарами! Мишура добавит блеска и уюта вашему дому, а пушистые елки станут центром праздника. Удобные, красивые и качественные украшения сделают подготовку к Новому году легкой и приятной.", menu: "good3Menu" },
	{
		name: "Ночники",
		description:
